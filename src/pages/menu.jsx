      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-12">
          <div className="flex-shrink-0 md:hidden flex items-center justify-center mr-3">
            <button
              className="text-gray-950 hover:text-gray-300 focus:outline-none"
          ...
          >
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <a href="#" className="text-gray-950 hover:bg-sky-500 block">
                Home
              </a>
              <a href="#" className="text-gray-950 hover:bg-sky-500 block">
                About
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              <a href="#" className="text-gray-950 hover:bg-sky-500">
                Home
              </a>
              <a href="#" className="text-gray-950 hover:bg-sky-500">
                About
